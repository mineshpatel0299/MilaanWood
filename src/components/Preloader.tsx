      ...
      {!isExiting ? (
        ...
        >
          ...
          >
            <button
              onClick={handleEnter}
              className="group relative px-10 py-4 border border-white/40 text-white text-[11px] tracking-[0.4em] uppercase cursor-pointer backdrop-blur-sm bg-black/10 hover:bg-white hover:text-black transition-all duration-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
            >
              Enter
