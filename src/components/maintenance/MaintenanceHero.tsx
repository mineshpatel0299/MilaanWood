...
export default function MaintenanceHero() {
 ...
 <div className="absolute left-[33%] top-0 w-px h-full bg-neutral-100" />
 <div className="absolute left-[66%] top-0 w-px h-full bg-neutral-100" />
 </div>
 ...
 >
 Preserving{" "}
 <span className=" text-neutral-400">Your Investment</span>
 </motion.h1>
 ...
 >
 A Milan Wood door is built to last decades. These simple care practices will keep its beauty and performance intact for the lifetime of your home.
 </motion.p>
 </motion.div>
 </div>
 </div>
