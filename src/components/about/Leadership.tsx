...
export default function Leadership() {
 ...
 <span className={`text-[10px] md:text-[11px] uppercase tracking-wider transition-colors duration-500 ${isActive ? "text-[#c1a077]" : "text-white/20"}`}>
 {leader.eyebrow}
 </span>
 </div>
 </div>
 ...
 <p className="text-xl md:text-2xl text-white font-light leading-snug mb-3 ">
 &ldquo;{active.quote}&rdquo;
 </p>

 <p className="text-white/40 text-sm uppercase tracking-wide mb-10">
 {active.title}
 </p>
