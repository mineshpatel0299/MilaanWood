...
export default function IndiaPresenceMap() {
 ...
 >
 Rooted in India, <span className=" text-neutral-400">Delivered Nationwide.</span>
 </motion.h2>
 </div>
 ...
 {/* Sea labels */}
 <text x="150" y="290" fontSize="15" fontStyle="" fill="#9aa8ab" fontFamily="serif">
 Arabian Sea
 </text>
 <text x="740" y="290" fontSize="15" fontStyle="" fill="#9aa8ab" fontFamily="serif">
 Bay of Bengal
 </text>
 <text x="440" y="465" fontSize="15" fontStyle="" fill="#9aa8ab" fontFamily="serif">
 Indian Ocean
 </text>
 ...
 {/* Tooltip */}
 {hovered && (
 <div className="absolute top-4 left-4 bg-[#0a0a0a] text-white text-xs px-4 py-2 tracking-wide uppercase pointer-events-none">
 {hovered}
 </div>
 )}
 ...
 <Link
 href="/contact"
 className="absolute bottom-4 left-4 md:bottom-6 md:left-6 inline-flex items-center bg-[#0a0a0a] text-white px-5 py-3 text-[10px] md:text-[11px] font-medium uppercase tracking-wider hover:bg-[#1a1a1a] transition-colors duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
 >
 Get In Touch
 </Link>
 </motion.div>
