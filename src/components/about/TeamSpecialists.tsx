    ...
    <section className="bg-white px-6 md:px-16 lg:px-24 py-24 md:py-32">
      <div className="max-w-[1400px] mx-auto">
        <div className="text-center max-w-2xl mx-auto mb-16 md:mb-20">
          ...
          >
            Our Trusted Team <br />
            <span className="italic text-neutral-400">of Specialists</span>
          </motion.h2>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-6">
          {TEAM.map((member, idx) => (
            ...
            >
              ...
              <p className="text-neutral-400 text-[10px] md:text-[11px] uppercase tracking-[0.2em] mb-4">
                {member.title}
              </p>

              <a
                href="/contact"
                className="inline-flex items-center gap-2 text-[10px] font-medium uppercase tracking-[0.25em] text-[#c1a077] hover:text-neutral-900 transition-colors duration-300 w-fit focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#c1a077]"
              >
                Contact
