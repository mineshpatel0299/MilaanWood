  ...
  return (
    <div className="bg-[#faf9f8] text-neutral-900 selection:bg-[#c1a077] selection:text-white">
      ...
      <nav className="absolute top-0 left-0 w-full z-50 px-6 md:px-12 py-8 flex items-center justify-between pointer-events-none">
        <Link href="/collections" className="pointer-events-auto flex items-center gap-3 text-neutral-500 hover:text-neutral-900 transition-colors text-xs tracking-[0.2em] uppercase font-medium">
      ...
      <section className="pt-32 pb-16 px-6 md:px-16 lg:px-32 max-w-[1600px] mx-auto text-center">
        <p className="text-[#c1a077] text-[10px] md:text-xs tracking-[0.4em] uppercase font-bold mb-6">{product.category}</p>
        <h1 className="text-5xl md:text-7xl lg:text-[6rem] font-light tracking-tight leading-[1.05] text-neutral-900 mb-8">
          {product.name}
        </h1>
        <p className="text-xl md:text-2xl font-light text-neutral-400 italic max-w-3xl mx-auto leading-relaxed">
        ...
        <div className="flex flex-col lg:flex-row gap-6 md:gap-8 h-auto lg:h-[80vh]">
          ...
          <div className="w-full lg:w-[65%] h-[70vh] lg:h-full relative bg-neutral-100 overflow-hidden group">
            <Image 
              ...
              priority
            />
            <div className="absolute bottom-8 left-8 text-white text-[10px] tracking-[0.3em] uppercase mix-blend-difference font-medium">
          ...
          <div className="w-full lg:w-[35%] flex flex-col gap-6 md:gap-8 h-auto lg:h-full">
            <div className="relative h-[50vh] lg:h-[60%] w-full bg-neutral-100 overflow-hidden group">
              <Image 
                ...
                className="object-cover transition-transform duration-[3s] group-hover:scale-[1.03]"
              />
              <div className="absolute bottom-6 left-6 text-white text-[10px] tracking-[0.3em] uppercase mix-blend-difference font-medium">
                Figure 02 — Detail
              </div>
            </div>
        ...
        <div className="flex flex-col lg:flex-row gap-20 lg:gap-32">
          ...
          <div className="lg:w-7/12 flex flex-col gap-12">
            ...
            <div className="border-t border-neutral-200 pt-8">
              <h3 className="text-xs tracking-[0.25em] uppercase font-medium text-neutral-400 mb-6">Overview</h3>
          ...
          <div className="lg:w-5/12">
            <div className="sticky top-32 bg-white border border-neutral-200 p-8 md:p-12 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)]">
              ...
              {/* Swatches */}
              <div className="mb-10">
                <h3 className="text-[10px] tracking-[0.2em] uppercase font-bold text-neutral-900 mb-4">Available Colours</h3>
              ...
              {/* Finishes */}
              <div className="mb-12">
                <h3 className="text-[10px] tracking-[0.2em] uppercase font-bold text-neutral-900 mb-4">Finishes</h3>
              ...
              <div className="flex flex-col gap-4">
                <button className="w-full bg-neutral-900 text-white py-5 text-xs font-bold tracking-[0.25em] uppercase hover:bg-[#c1a077] transition-colors duration-500">
                  Request Quote
                </button>
                <button className="w-full border border-neutral-200 text-neutral-900 py-5 text-xs font-bold tracking-[0.25em] uppercase hover:border-neutral-900 transition-colors duration-500">
                  WhatsApp Inquiry
                </button>
              </div>
            </div>
      ...
      <section className="py-24 px-6 md:px-16 lg:px-32 bg-white border-t border-neutral-200">
        <div className="max-w-[1600px] mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-32">
          <div className="w-full lg:w-1/2">
            <p className="text-[#c1a077] text-xs tracking-[0.3em] uppercase font-bold mb-6">Engineering</p>
            <h2 className="text-4xl md:text-5xl font-light leading-[1.1] mb-8">Crafted for <br/><span className="text-neutral-400 italic">Longevity</span></h2>
          ...
          <div className="w-full lg:w-1/2 aspect-square relative bg-[#faf9f8] flex items-center justify-center p-12">
             <div className="w-full h-full border border-neutral-200 flex items-center justify-center relative bg-white shadow-sm">
                <span className="text-neutral-300 tracking-[0.3em] uppercase text-xs font-medium">Exploded Diagram Schema</span>
             </div>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-16">
          {product.relatedProducts.map((relProduct, i) => (
            <Link key={i} href={`/product/${relProduct.id}`} className="group flex flex-col">
              ...
              <p className="text-[10px] tracking-[0.3em] uppercase text-neutral-400 mb-2">{relProduct.material}</p>
...
function Accordion({ title, children, defaultOpen = false }: { title: string, children: React.ReactNode, defaultOpen?: boolean }) {
  ...
  return (
    <div className="border-b border-neutral-200">
      ...
      >
        <span className="text-sm tracking-[0.2em] uppercase font-medium text-neutral-900 group-hover:text-[#c1a077] transition-colors">{title}</span>
