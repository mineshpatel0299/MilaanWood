...
function MobileItem({
 ...
 >
 <span
 className={`shrink-0 text-[10px] font-bold tracking-wider pt-1 transition-colors duration-300 ${
...
export default function FAQ() {
 ...
 <span className=" text-neutral-400">need to know.</span>
 </h2>
 </motion.div>
 </motion.div>
 ...
 {/* Number */}
 <span
 className={`shrink-0 text-[10px] font-bold tracking-wider transition-colors duration-300 ${
 ...
 {/* Active number label */}
 <p className="text-[10px] uppercase tracking-widest text-[#8b3d30] font-bold mb-6">
