...
export default function Philosophy() {
 ...
 className="text-[10px] md:text-[11px] tracking-widest text-neutral-400 uppercase mb-10 md:mb-14"
 >
 Our Philosophy
 </motion.p>
 ...
 >
 Precision meets crafting <span className=" text-neutral-400">interiors</span><br />
