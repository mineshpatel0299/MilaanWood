...
export default function FurnishCorner() {
 return (
 <section className="bg-white border-y border-neutral-200 py-24 md:py-32 lg:py-40">
 <div className="max-w-[1400px] mx-auto">
 <div className="flex flex-col lg:flex-row">
 {/* Left Text Column */}
 <div className="lg:w-1/3 px-6 py-12 md:px-12 lg:px-16 lg:py-0 lg:border-r border-neutral-200 flex flex-col justify-center">
 ...
 <div className="lg:w-2/3 px-6 py-12 md:px-12 lg:px-16 lg:py-0 flex flex-col md:flex-row gap-12 lg:gap-16 items-center">
 {/* Image */}
