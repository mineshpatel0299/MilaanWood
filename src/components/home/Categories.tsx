...
export default function Categories() {
 ...
 >
 <div className="text-[11px] font-bold tracking-wide text-neutral-900 w-12 text-center transition-opacity duration-300">
 {activeCategory ? `0${categories.findIndex(c => c.id === expandedId) + 1} / 0${categories.length}` : ''}
 </div>
 <div className="h-[200px] flex items-center justify-center">
 <div className="text-sm font-semibold tracking-widest uppercase text-neutral-900 -rotate-90 whitespace-nowrap">
 Categories
 </div>
 </div>
 </div>
 ...
 <div className="text-[11px] font-bold tracking-wide text-neutral-900">
 {activeCategory ? `0${categories.findIndex(c => c.id === expandedId) + 1} / 0${categories.length}` : ''}
 </div>
 <div className="text-xs font-semibold tracking-widest uppercase text-neutral-900">
 Categories
 </div>
 </div>
 ...
 className="text-xs md:text-sm font-bold uppercase tracking-wider text-neutral-900 mb-2"
 >
 {activeCategory.title}
 </motion.h2>
 <motion.p 
 initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2, duration: 0.8 }}
 className="text-[11px] md:text-xs text-neutral-500"
 >
 ...
 >
 <button className="flex items-center gap-4 text-[10px] md:text-xs font-bold uppercase tracking-wide text-neutral-900 hover:text-neutral-500 transition-colors duration-300 group">
 Explore Collection
