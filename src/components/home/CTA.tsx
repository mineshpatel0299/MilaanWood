...
export default function CTA() {
 ...
 unoptimized
 />
 <p className="text-[10px] md:text-[11px] tracking-wider uppercase text-[#c9a568] leading-relaxed">
 ...
 className="max-w-xl"
 >
 <span className="text-[10px] tracking-wider uppercase font-medium text-[#c9a568] mb-4 block">
 Let&apos;s Keep In Touch
 </span>
 ...
 <button
 type="submit"
 className="flex items-center gap-3 border-l border-[#c9a568]/60 px-6 py-4 text-[11px] font-medium tracking-wide uppercase text-[#c9a568] hover:bg-[#c9a568] hover:text-black transition-colors duration-300 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#c9a568] whitespace-nowrap"
 >
 Request Newsletter
 <ArrowRight size={14} />
 </button>
