...
export default function Services() {
 ...
 >
 <h2 className="text-center text-lg md:text-2xl font-medium tracking-wide uppercase text-neutral-900 mb-10 md:mb-16 px-4 md:px-8"> Crafting Premium Spaces </h2>
 ...
 >
 <h3 className="text-base md:text-xl tracking-wide uppercase font-bold mb-4 md:mb-8">
 {service.title}
 </h3>
 <button
 className={`border px-6 md:px-8 py-2 md:py-3 text-[11px] tracking-wide uppercase transition-colors duration-300 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white ${
 isHovered
