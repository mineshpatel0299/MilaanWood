    ...
    <section className="bg-white px-6 md:px-16 lg:px-24 py-24 md:py-32">
      <div className="max-w-[1400px] mx-auto flex flex-col gap-16">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
          ...
          >
            <span className="text-[10px] tracking-[0.3em] uppercase font-medium text-neutral-400 mb-4 block">
              The Journal
            </span>
            <h2 className="text-3xl md:text-5xl font-light text-neutral-900 leading-[1.1] tracking-tight">
              Insights &amp; <span className="italic text-neutral-400">Craftsmanship.</span>
            </h2>
          </motion.div>
          ...
          >
            <Link
              href="/blog"
              className="inline-flex items-center gap-2 text-xs tracking-[0.2em] uppercase font-medium text-neutral-900 hover:text-neutral-500 transition-colors group"
            >
              View All Articles
