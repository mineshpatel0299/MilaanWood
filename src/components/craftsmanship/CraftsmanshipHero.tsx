...
export default function CraftsmanshipHero() {
 ...
 Where Wood{" "}
 <br />
 <span className=" text-white/60">Becomes Art</span>
 </motion.h1>
 ...
 >
 Every Milan Wood door is born from a meticulous, six-stage journey — from raw timber to a finished masterpiece built to outlast generations.
 </motion.p>
 </motion.div>
 </div>
 </div>
