...
export default function Footer() {
 ...
 className="bg-[#0d0d0d] text-white pt-10 pb-6 px-6 md:px-16 font-sans relative z-20"
 >
 <div className="max-w-[1536px] mx-auto">
 <div
 className="grid grid-cols-2 md:grid-cols-3 gap-x-8 gap-y-10 mb-10 md:mb-12 transition-all duration-700 ease-out"
 style={{
 opacity: inView ? 1 : 0,
 ...
 <h4 className="text-[11px] font-bold uppercase tracking-wider text-[#c9a568]">Collections</h4>
 ...
 className="group flex items-center justify-between text-sm text-[#c9a568] hover:text-white transition-colors duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
 >
 ★ Signature Series
 <ChevronRight size={14} className="text-[#c9a568] opacity-0 group-hover:opacity-100 -translate-x-1 group-hover:translate-x-0 transition-all duration-300" />
 </Link>
 ...
 <h4 className="text-[11px] font-bold uppercase tracking-wider text-[#c9a568]">Company</h4>
 <div className="h-px w-6 bg-[#c9a568]/60" />
 <div className="flex flex-col gap-3">
 {[
 ...
 { label: 'Maintenance & Care', href: '/maintenance' },
 ...
 {/* Connect */}
 <div className="col-span-2 md:col-span-1 flex flex-col gap-5">
 <h4 className="text-[11px] font-bold uppercase tracking-wider text-[#c9a568]">Connect</h4>
 <div className="h-px w-6 bg-[#c9a568]/60" />
 ...
 <Link
 href="/contact"
 className="inline-flex items-center gap-3 border border-[#c9a568]/60 hover:border-[#c9a568] hover:bg-[#c9a568] hover:text-black px-6 py-3 text-[11px] font-medium tracking-wide uppercase text-[#c9a568] transition-colors duration-300 w-fit focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#c9a568]"
 >
 Book a Consultation
 <ArrowRight size={14} />
 </Link>
 ...
 {/* Bottom bar */}
 <div
 className="border-t border-white/10 pt-5 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-neutral-500 transition-all duration-700 ease-out"
 style={{
 opacity: inView ? 1 : 0,
 ...
 <span className="text-[10px] tracking-wide uppercase text-neutral-500">Follow Us</span>
 {SOCIALS.map((social) => (
 <a
 key={social.label}
 href={social.href}
