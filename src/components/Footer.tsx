  ...
  return (
    ...
    >
      <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row justify-between gap-24 mb-32">
        ...
        >
          <div className="flex items-center gap-2 font-bold text-xl tracking-[0.2em] text-white mb-8">
            <Image
          ...
          <p className="text-neutral-400 leading-relaxed max-w-xs text-sm">
        ...
        {/* Links + Newsletter */}
        <div
          className="md:w-2/3 flex flex-col md:flex-row justify-between gap-16 transition-all duration-700 ease-out"
          style={{
            opacity: inView ? 1 : 0,
            transform: inView ? 'translateY(0)' : 'translateY(24px)',
        ...
        >
          <div className="flex flex-col gap-4">
            <h4 className="text-[10px] font-bold uppercase tracking-[0.3em] text-neutral-500 mb-4">Shop</h4>
            {['Dining Tables', 'Lounge Seating', 'Storage & Cabinets', 'Bed Frames'].map((item) => (
              <a key={item} href="#" className="text-sm text-white hover:text-neutral-300 transition-colors duration-300 hover:translate-x-1 inline-block">{item}</a>
            ))}
          </div>
          <div className="flex flex-col gap-4">
            <h4 className="text-[10px] font-bold uppercase tracking-[0.3em] text-neutral-500 mb-4">Company</h4>
            {['Our Philosophy', 'Sustainability', 'Journal', 'Contact'].map((item) => (
              <a key={item} href="#" className="text-sm text-white hover:text-neutral-300 transition-colors duration-300 hover:translate-x-1 inline-block">{item}</a>
            ))}
          </div>
          <div className="flex flex-col gap-4 max-w-xs">
            <h4 className="text-[10px] font-bold uppercase tracking-[0.3em] text-neutral-500 mb-4">Newsletter</h4>
