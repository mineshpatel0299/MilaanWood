...
export default function CollectionGrid() {
 ...
 <p className="text-white/70 text-xs tracking-wide line-clamp-2 pr-4">
 {collection.description}
 </p>
 </div>
 <div className="bg-white/20 backdrop-blur-sm p-3 rounded-full group-hover:bg-white transition-colors duration-300 shrink-0">
