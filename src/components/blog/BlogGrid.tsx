...
export default function BlogGrid() {
 ...
 <span className="text-[10px] tracking-wider uppercase font-medium text-neutral-900 border border-neutral-900 px-3 py-1">
 ...
 <div className="flex items-center gap-2 text-xs tracking-wide uppercase font-medium text-neutral-900 group-hover:text-neutral-500 transition-colors">
 Read Article
