...
export default async function BlogPostPage({ params }: Props) {
 ...
 <span className="text-[10px] tracking-wider uppercase font-medium text-white border border-white/30 px-3 py-1 backdrop-blur-sm">
 {post.category}
 </span>
 <span className="text-[10px] tracking-wide uppercase text-white/70">
 {post.readTime}
 </span>
 </div>
 ...
 <p className="text-sm md:text-base text-white/60 tracking-wide uppercase">
 ...
 <Link 
 href="/blog"
 className="inline-flex items-center gap-2 text-xs tracking-wide uppercase text-neutral-400 hover:text-neutral-900 transition-colors group"
 >
 ...
 <p className="text-2xl md:text-4xl text-neutral-900 font-light leading-relaxed mb-24 text-center text-balance font-serif">
 "{post.excerpt}"
 </p>
 ...
 <p className="text-2xl md:text-4xl text-neutral-900 font-light leading-relaxed">
 "{quoteText}"
 </p>
 </blockquote>
 );
 ...
 <button className="text-[10px] tracking-wide uppercase font-medium text-neutral-500 hover:text-neutral-900 transition-colors font-sans border border-neutral-200 px-4 py-2">
 Share Article
 </button>
 </div>
 </div>
